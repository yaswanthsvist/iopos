...
angular.module('yaru22.angular-timeago', [
  ...
  return {
    ...
    link: function(scope, elem) {
      ...
      scope.$watch(function () {
        ...
        angular.element(elem).text(timeAgo.inWords(value, fromTime, scope.format,scope.fix));
      });
    }
  };
  ...
  service.settings = {
    ...
    strings: {
      ...
      'en_US': {
        prefixAgo: "ride over",
        prefixFromNow: "ride in",
        suffixAgo: 'ago',
        suffixFromNow: null,//'from now',
  ...
  service.inWords = function (distanceMillis, fromTime, format, timezone,fix) {
    ...
    if(fix=!undefined&&fix=='prefix'){
      service.settings.strings["en_US"].prefixAgo = null;
      service.settings.strings["en_US"].prefixFromNow= null;
      service.settings.strings["en_US"].suffixFromNow= 'from now';
    }else{
      service.settings.strings["en_US"].prefixAgo = "ride over";
      service.settings.strings["en_US"].prefixFromNow= "ride in";
      service.settings.strings["en_US"].suffixFromNow= null;//'from now',
    }
  ...
  return function (value, format, timezone,fix) {
     var fromTime = timeAgo.parse(value);
    var diff = nowTime() - fromTime;
    return timeAgo.inWords(diff, fromTime, format, timezone,fix);
  };
}]);
